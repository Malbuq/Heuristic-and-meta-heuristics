...
def buildKeyboard(countKeys):
    return random.sample(range(countKeys), countKeys)
...
def calculateKeyboardFitness(keyboard):
    cost = 0

    input_text_path = "Final Project\Text\preprocessed-file.txt"
...
standardKeyboard = [16, 22, 4, 17, 19, 24, 20, 8, 14, 15, 30,
                     0, 18, 3, 5,   6, 7, 9, 10, 11, 26, 31,
                      25, 23, 2, 21,  1, 13,12,27, 28]

print(isKeyboardValid(standardKeyboard))

print(calculateKeyboardFitness(standardKeyboard))